...
const questions = [
  ...
  QuizQuestion(
    ...
    [
      ...
      'Já dei PT em um carro',
      'Já fui salva-vidas',
    ],
  ),
  QuizQuestion(
    'Qual é a mentira sobre o Vitor?',
    [
      'Sou nerd e gosto de anime',
      'Casei com 23 anos',
      'Fui atleta profissional de futebol',
    ],
  ),
  QuizQuestion(
  ...
  QuizQuestion(
    ...
    [
      ...
      'Já fui pego no aeroporto de Madri e quase fui preso',
    ],
  ),
];
